...
{ 
    ...
    public class ResolutionMonitorEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //category = EditorGUILayout.Foldout(category == Category.StaticMethods, "Static Sizer Methods") ? Category.StaticMethods : category;
            ...
            // DPI OVERRIDES
            //EditorStyles.foldout.fontStyle = FontStyle.Bold;
            //category = EditorGUILayout.Foldout(category == Category.DpiManager, "DPI Overwrites") ? Category.DpiManager : category;
            //EditorStyles.foldout.fontStyle = origFontStyle;
