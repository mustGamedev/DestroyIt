...
namespace TheraBytes.BetterUi.Editor
{
    public class ImageAppearanceProviderEditorHelper
    {
        ...
        private SerializedProperty colorMode, firstColor, secondColor;
        ...
        public ImageAppearanceProviderEditorHelper(SerializedObject serializedObject, IImageAppearanceProvider img)
        {
            ...
            this.colorMode = serializedObject.FindProperty("colorMode");
            this.firstColor = serializedObject.FindProperty("m_Color");
            this.secondColor = serializedObject.FindProperty("secondColor");
        ...
        public void DrawInspectorGui(SerializedProperty materialProp)
        {
            // COLOR
