...
namespace TheraBytes.BetterUi.Editor
{
    ...
    public class LocationAnimationsEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty locationListProp, transitionListProp, startLocProp, startupAniProp, initCallbackProp;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (BoldFoldout("Locations", ref locationListExpanded))
            {
                for (int i = 0; i < locationListProp.arraySize; i++)
                {
                    ...
                    if (expanded)
                    {
                        ScreenConfigConnectionHelper.DrawGui(nameProp.stringValue, configsProp, ref fallbackProp, null, (n, obj) =>
                        {
